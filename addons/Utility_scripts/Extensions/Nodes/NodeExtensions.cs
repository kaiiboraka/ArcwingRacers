...
public static class NodeExtensions
{
	...
	public static void AddCollisionLayer2D(this CollisionObject2D node, LayerNames.PHYSICS_2D layer)
	{
		Callable.From(()=>node.SetCollisionLayerValue((int)layer, true)).CallDeferred();
	}

	public static void RemoveCollisionLayer2D(this CollisionObject2D node, LayerNames.PHYSICS_2D layer)
	{
		Callable.From(()=>node.SetCollisionLayerValue((int)layer, false)).CallDeferred();
	}

	public static void ToggleCollisionLayer2D(this CollisionObject2D node, LayerNames.PHYSICS_2D layer)
	{
	...
	public static void AddCollisionLayer3D(this CollisionObject3D node, LayerNames.PHYSICS_3D layer)
	{
		node.SetCollisionLayerValue((int)layer, true);
	}

	public static void RemoveCollisionLayer3D(this CollisionObject3D node, LayerNames.PHYSICS_3D layer)
	{
		node.SetCollisionLayerValue((int)layer, false);
	}

	public static void ToggleCollisionLayer3D(this CollisionObject3D node, LayerNames.PHYSICS_3D layer)
	{
		bool oldValue = node.GetCollisionLayerValue((int)layer);
		node.SetCollisionLayerValue((int)layer, !oldValue);
	}

	public static void AddCollisionMask2D(this CollisionObject2D node, LayerNames.PHYSICS_2D mask)
	{
		node.SetCollisionMaskValue((int)mask, true);
	}

	public static void RemoveCollisionMask2D(this CollisionObject2D node, LayerNames.PHYSICS_2D mask)
	{
		node.SetCollisionMaskValue((int)mask, false);
	}

	public static void ToggleCollisionMask2D(this CollisionObject2D node, LayerNames.PHYSICS_2D mask)
	{
		bool oldValue = node.GetCollisionMaskValue((int)mask);
		node.SetCollisionMaskValue((int)mask, !oldValue);
	}

	public static void AddCollisionMask3D(this CollisionObject3D node, LayerNames.PHYSICS_3D mask)
	{
		node.SetCollisionMaskValue((int)mask, true);
	}

	public static void RemoveCollisionMask3D(this CollisionObject3D node, LayerNames.PHYSICS_3D mask)
	{
		node.SetCollisionMaskValue((int)mask, false);
	}

	public static void ToggleCollisionMask3D(this CollisionObject3D node, LayerNames.PHYSICS_3D mask)
	{
		bool oldValue = node.GetCollisionMaskValue((int)mask);
		node.SetCollisionMaskValue((int)mask, !oldValue);
	}
